...
def index(request):
    ...
    topheadlines = newsapi.get_top_headlines(sources='TechRadar,techcrunch,wired,engadget,the-next-web,the-verge, bbc-news')
...
def bbcnews(request):
    ...
    return render(request, 'bbcnews.html', context={"mylist":mylist})    
    
def India(request):
    newsapi = NewsApiClient(api_key="0970422131d54ca9bc6cf35ac67d620c")
